        ...
        <div className="centered">
            ...
            <div className="paragraph-container">
                <p className="cards-description">
                    At ASM Yachts we believe that every yacht should look its best and operate at the highest level
                    wherever it is in the world. That is why our team will always go the extra mile to provide you with
                    a stress-free, extraordinary experience whilst on the ocean waves.
                </p>
            </div>
        </div>
    );
