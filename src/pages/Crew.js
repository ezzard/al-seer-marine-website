        ...
        />
                ...
                <SubHero
                    ...
                    blockText={
                        <span className="blue-text">
                            At ASM Yachts we are looking for talented, dedicated individuals who know how to go the
                            extra mile. Whatever your level of experience, we can provide the right training and
                            certifications to get you on the water and into a job that is fulfilling and rewarding. Our
                            Crew Management Division will help you find the right position, coordinate your training and
                            match you with the perfect crew team. Once you are on board, they take care of all the nitty
                            gritty including administration, HR &amp; payroll services, insurance and transport.
                        </span>
                    }
                />
            </div>
            <div className="bg-white">
                <SubHero
                    ...
                    blockText={
                        <span className="blue-text">
                            We are extremely proud of the diverse team at ASM Yachts, spanning a variety of backgrounds
                            and over 47 different nationalities. We believe in investing our staff at every level from
                            training to benefits to promotional opportunities. Our entire team knows that they have the
                            support and guidance they need to meet their potential and go the extra mile for our guests.
                            Ultimately, when you join ASM Yachts, you are joining a family, destined for the
                            extraordinary.{" "}
                        </span>
                    }
                />
            ...
            <div className="footer-navigation-crew">
                <div className="button-description">
                    <p>
                        If you want to find out more about whether you have what it takes to join our super crew and how
